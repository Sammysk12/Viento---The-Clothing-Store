...
const Footer = () => {
  return (
    <footer className='border-t py-12'>
        ...
        {/* This contains the newsletter section and subscribe form */}
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0' >
            <div>
                <h3 className='text-lg text-gray-800 mb-4'>NewsLetter</h3>
                <p className='text-gray-500 mb-4'>Be the fisrt to hear about new products, exclusive events, and online offers.</p>
          ...
          <div>
            ...
            <div className='flex items-center space-x-4 mb-6'>
              <a href="https://www.fackbook.com" target='_blank' rel='noopener noreferer' className='hover:text-gray-400'>
