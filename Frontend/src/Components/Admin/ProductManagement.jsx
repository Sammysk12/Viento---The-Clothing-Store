...
const handleDeleteProduct = (productId) => {
  ...
  return (
    <div className='max-w-7xl mx-auto p-6'>
      <h6 className='text-2xl font-bold mb-6'>Product Management</h6>
                  ...
                  products.map((product) => 
                    <tr key={product._id} className='border-b hover:bg-gray-50 cursor-pointer'>
                      ...
                      <td className='p-4'>
                        ...
                        <button onClick={() =>handleDeleteProduct(product._id)} className='bg-red-500 text-white px-2 py-1 rounded hover:bg-red-600'>Delete</button>
                      </td>
