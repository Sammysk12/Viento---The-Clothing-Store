...
import { HiArrowPath, HiOutlineCreditCard, HiShoppingBag } from 'react-icons/hi2'
    ...
    <section className='py-16 bg-white'>
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <p className='text-gray-600 text-sm tracking-tighter'>100% secured checkout processc</p>
            </div>
