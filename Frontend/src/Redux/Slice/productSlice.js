...
export const  fetchProductDetails = createAsyncThunk("products/fetchProdcutDetails", async(id) => {
...
//
export const updateProduct = createAsyncThunk('products/updateProducts', async({id, productData}) =>{
...
const productSlice = createSlice({
    ...
    extraReducers : (builder) => {
        ...
        //handle fetching Update product
