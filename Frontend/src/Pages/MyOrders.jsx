...
const MyOrders = () => {
    ...
    const navigateToOrderId = useNavigate();
    ...
    const handleOrderDetails = (orderId) => {
        navigateToOrderId(`/order/${orderId}`)
    }
            ...
            <table className='min-w-full text-left text-gray-500'>
                ...
                <tbody>
                    {orders.length > 0 ? (orders.map((order) =>{ 
                        return(
                            <tr key={order._id} onClick={() => handleOrderDetails(order._id)} className='border-b hover:border-gray-50 cursor-pointer'>
                     ...
                     : (
                        <tr>
                            <td colSpan={7} className='py-4 px-4 text-center text-gray-500'>You have to orders</td>
                        </tr>
                     )
                    }
                </tbody>
